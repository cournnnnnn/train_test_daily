...
if __name__ == '__main__':
    ANNOTATIONS_PATH = "/home/chan/dataset/抽烟/xml"
    input_cfg_width = 608
    ...
    annotations_array = np.array(data, dtype=np.float32)
    ...
    for anchor in anchors:
        print([int(anchor[0] * input_cfg_width), int(anchor[1] * input_cfg_height)],',')
